...
public class Datum {
    ...
    @JsonProperty("areaAccessRestrictions")
    private AreaAccessRestrictions areaAccessRestrictions;
    @JsonProperty("areaPolicy")
    private AreaPolicy areaPolicy;
    @JsonProperty("subArea")
    private List<SubArea> subArea = null;
    ...
    @JsonProperty("areaAccessRestrictions")
    public AreaAccessRestrictions getAreaAccessRestrictions() {
        return areaAccessRestrictions;
    }

    @JsonProperty("areaAccessRestrictions")
    public void setAreaAccessRestrictions(AreaAccessRestrictions areaAccessRestrictions) {
        this.areaAccessRestrictions = areaAccessRestrictions;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("areaAccessRestrictions");
        sb.append('=');
        sb.append(((this.areaAccessRestrictions == null)?"<null>":this.areaAccessRestrictions));
        sb.append(',');
        ...
        sb.append("subArea");
        sb.append('=');
        sb.append(((this.subArea == null)?"<null>":this.subArea));
        sb.append(',');
